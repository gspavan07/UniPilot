                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <label
                                    ...
                                    className="block w-12 h-7 bg-gray-200 peer-checked:bg-blue-600 rounded-full cursor-pointer transition-colors relative after:content-[''] after:absolute after:top-1 after:left-1 after:bg-white after:w-5 after:h-5 after:rounded-full after:transition-transform peer-checked:after:translate-x-5"
                                ></label>
                            </div>
                                                    ...
                                                    <div className="bg-gray-50 p-4 border-b border-gray-100 flex flex-wrap items-center gap-4">
                                                        <div className="flex-1 min-w-[200px]">
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                <input
                                                                    ...
                                                                    className="w-full pl-9 pr-3 py-2 bg-white border border-gray-200 rounded-lg text-sm font-bold text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
                                                        ...
                                                        <div className="w-32">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm font-semibold text-gray-900 focus:border-blue-500 outline-none"
                                                            />
                                                        </div>
                                                        <div className="w-32">
                                                                    ...
                                                                    <div className="w-24 shrink-0">
                                                                        ...
                                                                        <div className="relative group/input">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                className="w-full pl-8 pr-3 py-2.5 bg-gray-50 border border-transparent hover:bg-white hover:border-gray-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-xl text-sm font-bold text-gray-900 outline-none transition-all"
                                                                                placeholder="1"
                                                                            />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="w-28 shrink-0">
                                                                        ...
                                                                        <div className="relative group/input">
                                                                            <input
                                                                                ...
                                                                                className="w-full pl-4 pr-10 py-2.5 bg-gray-50 border border-transparent hover:bg-white hover:border-gray-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-xl text-sm font-bold text-gray-900 outline-none transition-all"
                                                                            />
                                                                        ...
                                                                        {q.sub_parts && q.sub_parts.length > 0 ? (
                                                                            ...
                                                                            <div className="relative group/select">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    className="w-full pl-9 pr-8 py-2.5 bg-gray-50 border border-transparent hover:bg-white hover:border-gray-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-xl text-sm font-bold text-gray-900 outline-none appearance-none transition-all cursor-pointer"
                                                                                >
                                                                                ...
                                                                                <div key={spIdx} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors group/sub">
                                                                                    ...
                                                                                    <div className="relative w-20">
                                                                                        <input
                                                                                            ...
                                                                                            className="w-full text-xs font-bold text-gray-700 bg-white border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-lg py-1.5 px-2 text-center transition-all"
                                                                                        />
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="relative w-20">
                                                                                        <input
                                                                                            ...
                                                                                            className="w-full text-xs font-medium text-gray-700 bg-white border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-lg py-1.5 px-2 text-center transition-all"
                                                                                        />
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="relative w-24">
                                                                                        <select
                                                                                            ...
                                                                                            className="w-full text-xs font-medium text-gray-700 bg-white border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-lg py-1.5 px-2 appearance-none cursor-pointer transition-all"
                                                                                        >
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-gray-900 flex items-baseline gap-1">
                                {targetStructure ? targetStructure.max_marks : '-'} <span className="text-sm font-medium text-gray-500 text-base">/ {targetStructure ? targetStructure.max_marks : '-'}</span>
                            </h3>
                        </div>
                    </div>
                </div>
