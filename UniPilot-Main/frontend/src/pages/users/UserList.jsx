...
const UserList = ({ role: forcedRole }) => {
  ...
  const getPageDesc = () => {
    ...
    return "Global user registry and access management.";
  };
  ...
  const getRoleBadge = (role) => {
    switch (role) {
      case "admin":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-red-50 text-red-700 border border-red-100">
            Admin
          </span>
        );
      case "faculty":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-700 border border-blue-100">
            Faculty
          </span>
        );
      case "staff":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-amber-50 text-amber-700 border border-amber-100">
            Staff
          </span>
        );
      case "student":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-green-50 text-green-700 border border-green-100">
            Student
          </span>
        );
      default:
        return (
          <span className="inline-flex items-center px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-gray-50 text-gray-600 border border-gray-100">
            {role}
          </span>
        );
    }
  ...
  const canCreate = (() => {
    ...
    if (roleSlug.includes("hr")) return true;
    return false;
  })();
  ...
  const canManageUser = (targetUser) => {
    ...
    if (myRoleSlug.includes("hr")) return targetRole !== "student";
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        <div className="flex flex-col gap-1.5 items-start">
                          ...
                          <span className="text-[10px] font-mono font-medium text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded uppercase tracking-tighter">
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-1 opacity-100 transition-all duration-200 translate-x-0 md:translate-x-2 md:group-hover:translate-x-0">
                          {(canManageUser(user) ||
